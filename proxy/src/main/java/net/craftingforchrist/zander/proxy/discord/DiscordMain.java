package net.craftingforchrist.zander.proxy.discord;

import lombok.Getter;
import net.craftingforchrist.zander.proxy.Variables;
import net.craftingforchrist.zander.proxy.ZanderProxyMain;
import net.craftingforchrist.zander.proxy.discord.commands.status;
import net.craftingforchrist.zander.proxy.discord.events.ChatEvent;
...
public class DiscordMain extends ListenerAdapter implements Listener {
    ...
    @Getter private ZanderProxyMain plugin;

    public DiscordMain(ZanderProxyMain plugin) {
        instance = this;
        this.plugin = plugin;
